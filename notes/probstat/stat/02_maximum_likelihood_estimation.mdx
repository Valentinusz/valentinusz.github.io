...
valószínűségi változó lehetséges értékei. Egyetlen ismeretlen paraméterünk van, amit $\lambda$-val jelölünk.
...
:::tip
A becslés során célszerű a függvény logaritmusát az ún. log-likelihood függvényt venni. Így a logaritmus azonosságait
kihasználva, jelentősen le tudjuk egyszerűsíteni a számításokat.
:::
...
(Még le kéne ellenőrizni, hogy $c$ valóban maximum hely-e ($f'$ pozitívból negatívba vált $c$-ben), de ez nem ennek a
tárgynak célja.)
:::
