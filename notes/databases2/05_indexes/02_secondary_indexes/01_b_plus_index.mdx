...
![B+ fa](/img/databases2/indexes/b_plus_tree.png)
...
![B+ fa belső csúcs](/img/databases2/indexes/b_plus_tree_inner_node.png)
...
![B+ fa levél](/img/databases2/indexes/b_plus_tree_leaf.png)
## B+ fa építése
...
![img.png](/img/databases2/indexes/b_plus_tree_insert/step1.png)
...
![img.png](/img/databases2/indexes/b_plus_tree_insert/step2.png)

A 79 könnyen beszúrható

![img.png](/img/databases2/indexes/b_plus_tree_insert/step3.png)

A 83 beszúrásánál szét kell osztanunk a csúcsot. A szinten még van hely, ezért nem kell új gyökércsúcsot felvenni.

![step4.png](/img/databases2/indexes/b_plus_tree_insert/step4.png)

A 72 és 43 gond nélkül beszúrható:

![step5.png](/img/databases2/indexes/b_plus_tree_insert/step5.png)

A 75 beszúrásakor szét kell osztanunk a csúcsot:

![step6.png](/img/databases2/indexes/b_plus_tree_insert/step6.png)
...
![step7.png](/img/databases2/indexes/b_plus_tree_insert/step7.png)
## B+ index tárigénye
