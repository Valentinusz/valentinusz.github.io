...
![Sűrű index](/img/databases2/indexes/dense_index.png)
...
![Ritka index](/img/databases2/indexes/sparse_index.png)

## Többszintű index

Az indexre is tudunk indexet készítene, mellyel tovább tudjuk növelni a hatékonyságot.

![Többszintű index](/img/databases2/indexes/multilevel_index.png)
